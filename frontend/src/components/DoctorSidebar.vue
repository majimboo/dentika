      ...
      <div class="p-6 border-b border-neutral-200/50">
        <div class="flex items-center space-x-3">
          <div class="h-8 w-8 bg-gradient-to-r from-green-600 to-emerald-600 rounded-lg flex items-center justify-center">
            <font-awesome-icon icon="fa-solid fa-stethoscope" class="h-5 w-5 text-white" />
          </div>
          <div>
            <h2 class="text-lg font-bold bg-gradient-to-r from-neutral-900 to-neutral-600 bg-clip-text text-transparent">Dentika</h2>
            <p class="text-xs text-neutral-500">Doctor Panel</p>
          </div>
        </div>
      </div>
          ...
          <ul class="space-y-2" role="list">
             <li role="listitem">
               <router-link
                 ...
                 class="group flex items-center px-3 py-2 text-sm font-medium text-neutral-600 rounded-xl hover:bg-green-50 hover:text-green-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500"
                 :class="{ 'bg-green-100 text-green-700 shadow-sm': $route.name === 'Dashboard' }"
                 :aria-current="$route.name === 'Dashboard' ? 'page' : null"
               >
                 <div class="flex items-center justify-center w-10 h-10 mr-3 rounded-lg bg-gray-100 group-hover:bg-green-200 transition-colors duration-200"
                      :class="{ 'bg-green-200': $route.name === 'Dashboard' }">
              ...
              <li role="listitem">
                <router-link
                  ...
                  @click="closeSidebarOnMobile"
                  class="group flex items-center px-3 py-2 text-sm font-medium text-neutral-600 rounded-xl hover:bg-green-50 hover:text-green-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500"
                  :class="{ 'bg-green-100 text-green-700 shadow-sm': $route.name === 'Agenda' }"
                  :aria-current="$route.name === 'Agenda' ? 'page' : null"
                >
                  <div class="flex items-center justify-center w-10 h-10 mr-3 rounded-lg bg-gray-100 group-hover:bg-green-200 transition-colors duration-200"
                       :class="{ 'bg-green-200': $route.name === 'Agenda' }">
              ...
              <li role="listitem">
                <router-link
                 ...
                 @click="closeSidebarOnMobile"
                 class="group flex items-center px-3 py-2 text-sm font-medium text-neutral-600 rounded-xl hover:bg-green-50 hover:text-green-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500"
                 :class="{ 'bg-green-100 text-green-700 shadow-sm': $route.path.startsWith('/patients') }"
                 :aria-current="$route.path.startsWith('/patients') ? 'page' : null"
               >
                 <div class="flex items-center justify-center w-10 h-10 mr-3 rounded-lg bg-gray-100 group-hover:bg-green-200 transition-colors duration-200"
                      :class="{ 'bg-green-200': $route.path.startsWith('/patients') }">
              ...
              <li role="listitem">
                <router-link
                  ...
                  @click="closeSidebarOnMobile"
                  class="group flex items-center px-3 py-2 text-sm font-medium text-neutral-600 rounded-xl hover:bg-green-50 hover:text-green-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500"
                  :class="{ 'bg-green-100 text-green-700 shadow-sm': $route.path.startsWith('/appointments') }"
                  :aria-current="$route.path.startsWith('/appointments') ? 'page' : null"
                >
                 <div class="flex items-center justify-center w-10 h-10 mr-3 rounded-lg bg-gray-100 group-hover:bg-green-200 transition-colors duration-200"
                      :class="{ 'bg-green-200': $route.path.startsWith('/appointments') }">
              ...
              <li role="listitem">
                <router-link
                  ...
                  @click="closeSidebarOnMobile"
                  class="group flex items-center px-3 py-2 text-sm font-medium text-neutral-600 rounded-xl hover:bg-green-50 hover:text-green-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500"
                  :class="{ 'bg-green-100 text-green-700 shadow-sm': $route.path.startsWith('/procedures') || $route.path.startsWith('/diagnoses') || $route.path.startsWith('/treatments') || $route.path.startsWith('/consent') || $route.path.startsWith('/prescriptions') }"
                  :aria-current="$route.path.startsWith('/procedures') ? 'page' : null"
                >
                  <div class="flex items-center justify-center w-10 h-10 mr-3 rounded-lg bg-gray-100 group-hover:bg-green-200 transition-colors duration-200"
                       :class="{ 'bg-green-200': $route.path.startsWith('/procedures') || $route.path.startsWith('/diagnoses') || $route.path.startsWith('/treatments') || $route.path.startsWith('/consent') || $route.path.startsWith('/prescriptions') }">
               ...
               <li role="listitem">
                 <router-link
                   ...
                   @click="closeSidebarOnMobile"
                   class="group flex items-center px-3 py-2 text-sm font-medium text-neutral-600 rounded-xl hover:bg-green-50 hover:text-green-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500"
                   :class="{ 'bg-green-100 text-green-700 shadow-sm': $route.path.startsWith('/peer-review') }"
                   :aria-current="$route.path.startsWith('/peer-review') ? 'page' : null"
                 >
                   <div class="flex items-center justify-center w-10 h-10 mr-3 rounded-lg bg-gray-100 group-hover:bg-green-200 transition-colors duration-200"
                        :class="{ 'bg-green-200': $route.path.startsWith('/peer-review') }">
                ...
                <li role="listitem">
                  <router-link
                    ...
                    @click="closeSidebarOnMobile"
                    class="group flex items-center px-3 py-2 text-sm font-medium text-neutral-600 rounded-xl hover:bg-green-50 hover:text-green-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500"
                    :class="{ 'bg-green-100 text-green-700 shadow-sm': $route.path.startsWith('/inventory') && !$route.path.includes('/shop') }"
                    :aria-current="$route.path.startsWith('/inventory') && !$route.path.includes('/shop') ? 'page' : null"
                  >
                    <div class="flex items-center justify-center w-10 h-10 mr-3 rounded-lg bg-gray-100 group-hover:bg-green-200 transition-colors duration-200"
                         :class="{ 'bg-green-200': $route.path.startsWith('/inventory') && !$route.path.includes('/shop') }">
                ...
                <li role="listitem">
                  <router-link
                    ...
                    @click="closeSidebarOnMobile"
                    class="group flex items-center px-3 py-2 text-sm font-medium text-neutral-600 rounded-xl hover:bg-green-50 hover:text-green-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500"
                    :class="{ 'bg-green-100 text-green-700 shadow-sm': $route.path.startsWith('/shop') }"
                    :aria-current="$route.path.startsWith('/shop') ? 'page' : null"
                  >
                    <div class="flex items-center justify-center w-10 h-10 mr-3 rounded-lg bg-gray-100 group-hover:bg-green-200 transition-colors duration-200"
                         :class="{ 'bg-green-200': $route.path.startsWith('/shop') }">
                      <font-awesome-icon icon="fa-solid fa-shopping-cart" class="w-5 h-5" />
                    </div>
                    <div class="min-w-0 flex-1">
                      <div class="font-medium truncate">Dentika Shop</div>
                      <div class="text-xs text-gray-400 truncate">Order supplies</div>
                    </div>
                  </router-link>
                </li>
          </ul>
