  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { level: 1, title: 'Procedures & Diagnoses', parent: 'Dashboard' }
      },
      {
        path: '/users',
        name: 'UserList',
      ...
      },
      {
        ...
        name: 'PatientEdit',
        component: PatientForm,
        meta: { level: 2, title: 'Edit Patient', parent: 'PatientList' }
      },
      {
        path: '/patients/:id',
        name: 'PatientView',
        component: PatientForm,
        meta: { level: 2, title: 'Patient Details', parent: 'PatientList' }
      },
      
      {
        ...
        meta: { level: 2, title: 'New Appointment', parent: 'AppointmentCalendar' }
      },
      {
        path: '/appointments/:id/edit',
        name: 'AppointmentEdit',
        component: AppointmentForm,
        meta: { level: 2, title: 'Edit Appointment', parent: 'AppointmentCalendar' }
      },
      
      {
        ...
        meta: { level: 2, title: 'New Procedure', parent: 'ProcedureManagement' }
      },
      {
        path: '/procedures/:id/edit',
        name: 'ProcedureEdit',
        component: ProcedureForm,
        meta: { level: 2, title: 'Edit Procedure', parent: 'ProcedureManagement' }
      },
      
      {
        ...
        meta: { level: 2, title: 'New Diagnosis', parent: 'ProcedureManagement' }
      },
      {
        path: '/diagnoses/:id/edit',
        name: 'DiagnosisEdit',
        component: DiagnosisForm,
        meta: { level: 2, title: 'Edit Diagnosis', parent: 'ProcedureManagement' }
      },
      
      {
        ...
        meta: { level: 2, title: 'New Treatment Plan', parent: 'ProcedureManagement' }
      },
      {
        path: '/treatments/:id',
        name: 'TreatmentView',
        component: TreatmentPlanForm,
        meta: { level: 2, title: 'Treatment Plan', parent: 'ProcedureManagement' }
      },
      {
        path: '/treatments/:id/edit',
        name: 'TreatmentEdit',
        component: TreatmentPlanForm,
        meta: { level: 2, title: 'Edit Treatment Plan', parent: 'ProcedureManagement' }
      },
      ...
      
      {
        ...
        meta: { level: 2, title: 'New Consent Form', parent: 'ProcedureManagement' }
      },
      
      {
        ...
        meta: { level: 2, title: 'New Prescription', parent: 'ProcedureManagement' }
      }
    ]
  }
]
