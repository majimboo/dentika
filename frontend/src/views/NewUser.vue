<template>
  <div class="space-y-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div>
        <h1 class="text-2xl sm:text-3xl font-bold text-neutral-900">Add New User</h1>
        <p class="mt-2 text-base sm:text-lg text-neutral-600">Create a new user account in the system</p>
      </div>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-8">
          ...
          <div class="pb-6 border-b border-neutral-200">
            ...
            <div v-if="!form.id" class="mt-2 text-sm text-gray-500 text-center">
              Save user first to upload avatar
            </div>
          </div>
          ...
          <div class="space-y-6">
            ...
            <div class="space-y-2">
              ...
              <input
                ...
                type="text"
                required
                class="block w-full px-4 py-3 border border-neutral-300 rounded-xl text-neutral-900 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 bg-neutral-50 hover:bg-white focus:bg-white"
            ...
            <div class="space-y-2">
              ...
              <select
                ...
                id="gender"
                name="gender"
                class="block w-full px-4 py-3 border border-neutral-300 rounded-xl text-neutral-900 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 bg-neutral-50 hover:bg-white focus:bg-white"
              >
            ...
            <div class="space-y-2">
              ...
              <p class="text-xs text-neutral-500 mt-1">
                ...
                <strong>Clinic Owner:</strong> Clinic management and staff<br>
            ...
            <!-- Clinic Assignment (shown when clinics are loaded) -->
            <div v-if="hasClinics" class="space-y-2">
              <label for="clinic_id" class="block text-sm font-semibold text-gray-700 flex items-center">
                ...
                Clinic Assignment
                <span v-if="form.role && form.role !== 'super_admin'" class="text-danger-500 ml-1">*</span>
              </label>
              <select
              ...
              <p v-if="!hasClinics" class="text-xs text-orange-600 mt-1">
                Loading clinics...
              </p>
              <p v-else-if="form.role === 'super_admin'" class="text-xs text-neutral-500 mt-1">
                Super admins don't need clinic assignment.
              </p>
          ...
          <div class="space-y-6 pt-6 border-t border-neutral-200">
            ...
            <p class="text-sm text-neutral-600">Create a secure password for this user account</p>
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <input
                  ...
                  required
                  minlength="8"
                  class="block w-full px-4 py-3 pr-12 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 bg-gray-50 hover:bg-white focus:bg-white"
          ...
          <BaseTransition name="fade">
            <div v-if="submitSuccess" class="bg-success-50 border border-success-200 rounded-xl p-4">
              <div class="flex items-center">
                ...
                <p class="text-sm text-success-700">User created successfully!</p>
              </div>
            </div>
          </BaseTransition>
          ...
          <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-6 border-t border-neutral-200">
            <button
              ...
              class="flex-1 sm:flex-none inline-flex justify-center items-center px-6 py-3 border border-transparent rounded-xl text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
            >
            ...
            <button
              ...
              @click="resetForm"
              :disabled="saving"
              class="flex-1 sm:flex-none inline-flex justify-center items-center px-6 py-3 border border-neutral-300 rounded-xl text-sm font-medium text-neutral-700 bg-white hover:bg-neutral-50 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
            >
              Reset
            </button>
          </div>
...
export default {
  ...
  setup() {
    ...
    const isFormValid = computed(() => {
      const basicValid = form.value.username &&
                        form.value.password &&
      ...
      // Clinic is required for non-super-admin roles
      if (form.value.role && form.value.role !== 'super_admin') {
        return basicValid && form.value.clinic_id
      }
    ...
    const loadClinics = async () => {
      try {
        ...
        if (result.success) {
          ...
          console.log('Clinics loaded:', result.data)
        } else {
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        const submitData = {
          ...
          clinic_id: form.value.role === 'super_admin' ? null : form.value.clinic_id
        }
