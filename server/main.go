	...
	filipinoPatients := []models.Patient{
		{
			...
			Email: "maria.santos@example.com", Phone: "+639171234567",
			DateOfBirth: &[]time.Time{time.Date(1985, 5, 15, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Female", Address: "123 Mabolo Street, Cebu City, 6000 Cebu",
			EmergencyContactName: "Juan Santos", EmergencyContactPhone: "+639182345678", EmergencyContactRelation: "Husband",
		...
		},
		{
			...
			Email: "jose.delacruz@example.com", Phone: "+639193456789",
			DateOfBirth: &[]time.Time{time.Date(1990, 8, 22, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Male", Address: "456 Banilad Street, Cebu City, 6000 Cebu",
			EmergencyContactName: "Maria Dela Cruz", EmergencyContactPhone: "+639204567890", EmergencyContactRelation: "Wife",
		...
		},
		{
			...
			Email: "ana.garcia@example.com", Phone: "+639215678901",
			...
			EmergencyContactName: "Pedro Garcia", EmergencyContactPhone: "+639226789012", EmergencyContactRelation: "Son",
		...
		},
		{
			...
			Email: "roberto.reyes@example.com", Phone: "+639237890123",
			DateOfBirth: &[]time.Time{time.Date(1982, 3, 5, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Male", Address: "321 Lahug Street, Cebu City, 6000 Cebu",
			EmergencyContactName: "Elena Reyes", EmergencyContactPhone: "+639248901234", EmergencyContactRelation: "Wife",
		...
		},
		{
			...
			Email: "carmen.villanueva@example.com", Phone: "+639259012345",
			DateOfBirth: &[]time.Time{time.Date(1995, 7, 18, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Female", Address: "654 Mandaue City, Cebu, 6014",
			EmergencyContactName: "Antonio Villanueva", EmergencyContactPhone: "+639260123456", EmergencyContactRelation: "Father",
		...
		},
		{
			...
			Email: "miguel.lopez@example.com", Phone: "+639271234567",
			DateOfBirth: &[]time.Time{time.Date(1968, 11, 30, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Male", Address: "987 Lapu-Lapu City, Cebu, 6015",
			EmergencyContactName: "Sofia Lopez", EmergencyContactPhone: "+639282345678", EmergencyContactRelation: "Daughter",
		...
		},
		{
			...
			Email: "grace.torres@example.com", Phone: "+639293456789",
			DateOfBirth: &[]time.Time{time.Date(1988, 4, 12, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Female", Address: "147 Capitol Site, Cebu City, 6000 Cebu",
			EmergencyContactName: "Ricardo Torres", EmergencyContactPhone: "+639304567890", EmergencyContactRelation: "Husband",
		...
		},
		{
			...
			Email: "fernando.mendoza@example.com", Phone: "+639315678901",
			DateOfBirth: &[]time.Time{time.Date(1972, 9, 25, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Male", Address: "258 Paseo de Legaspi, Makati City, 1229",
			EmergencyContactName: "Isabel Mendoza", EmergencyContactPhone: "+639326789012", EmergencyContactRelation: "Wife",
		...
		},
		{
			...
			Email: "luz.aquino@example.com", Phone: "+639337890123",
			DateOfBirth: &[]time.Time{time.Date(1992, 1, 8, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Female", Address: "369 BGC, Taguig City, 1634",
			EmergencyContactName: "Carlos Aquino", EmergencyContactPhone: "+639348901234", EmergencyContactRelation: "Brother",
		...
		},
		{
			...
			Email: "pedro.ramos@example.com", Phone: "+639359012345",
			DateOfBirth: &[]time.Time{time.Date(1980, 6, 14, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Male", Address: "741 Alabang, Muntinlupa City, 1771",
			EmergencyContactName: "Rosa Ramos", EmergencyContactPhone: "+639360123456", EmergencyContactRelation: "Sister",
		...
		},
		{
			...
			Email: "sofia.flores@example.com", Phone: "+639371234567",
			DateOfBirth: &[]time.Time{time.Date(1998, 10, 3, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Female", Address: "852 Quezon City, 1100",
			EmergencyContactName: "Manuel Flores", EmergencyContactPhone: "+639382345678", EmergencyContactRelation: "Father",
			BloodType: models.BloodTypeAPositive, Allergies: "None", MedicalConditions: "None",
		...
		},
		{
			...
			Email: "antonio.castro@example.com", Phone: "+639393456789",
			DateOfBirth: &[]time.Time{time.Date(1978, 2, 28, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Male", Address: "963 Pasig City, 1600",
			EmergencyContactName: "Teresa Castro", EmergencyContactPhone: "+639404567890", EmergencyContactRelation: "Wife",
		...
		},
		{
			...
			Email: "elena.morales@example.com", Phone: "+639415678901",
			DateOfBirth: &[]time.Time{time.Date(1986, 12, 7, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Female", Address: "159 Parañaque City, 1700",
			EmergencyContactName: "Diego Morales", EmergencyContactPhone: "+639426789012", EmergencyContactRelation: "Husband",
		...
		},
		{
			...
			Email: "ricardo.domingo@example.com", Phone: "+639437890123",
			DateOfBirth: &[]time.Time{time.Date(1994, 5, 20, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Male", Address: "357 Las Piñas City, 1740",
			EmergencyContactName: "Maria Domingo", EmergencyContactPhone: "+639448901234", EmergencyContactRelation: "Mother",
		...
		},
		{
			...
			Email: "isabel.salazar@example.com", Phone: "+639459012345",
			DateOfBirth: &[]time.Time{time.Date(1970, 8, 16, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Female", Address: "468 Valenzuela City, 1440",
			EmergencyContactName: "Francisco Salazar", EmergencyContactPhone: "+639460123456", EmergencyContactRelation: "Son",
		...
		},
		{
			...
			Email: "carlos.bautista@example.com", Phone: "+639471234567",
			DateOfBirth: &[]time.Time{time.Date(1984, 11, 9, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Male", Address: "579 Caloocan City, 1400",
			EmergencyContactName: "Lucia Bautista", EmergencyContactPhone: "+639482345678", EmergencyContactRelation: "Wife",
		...
		},
		{
			...
			Email: "teresa.hernandez@example.com", Phone: "+639493456789",
			DateOfBirth: &[]time.Time{time.Date(1996, 3, 22, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Female", Address: "680 Pasay City, 1300",
			EmergencyContactName: "Roberto Hernandez", EmergencyContactPhone: "+639504567890", EmergencyContactRelation: "Father",
		...
		},
		{
			...
			Email: "manuel.santiago@example.com", Phone: "+639515678901",
			DateOfBirth: &[]time.Time{time.Date(1976, 7, 4, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Male", Address: "791 Makati City, 1200",
			EmergencyContactName: "Carmen Santiago", EmergencyContactPhone: "+639526789012", EmergencyContactRelation: "Wife",
		...
		},
		{
			...
			Email: "rosa.gutierrez@example.com", Phone: "+639537890123",
			DateOfBirth: &[]time.Time{time.Date(1989, 9, 13, 0, 0, 0, 0, time.UTC)}[0],
			Gender:      "Female", Address: "802 Mandaluyong City, 1550",
			EmergencyContactName: "Jose Gutierrez", EmergencyContactPhone: "+639548901234", EmergencyContactRelation: "Husband",
